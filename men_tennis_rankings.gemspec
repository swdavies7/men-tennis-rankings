...
require 'men_tennis_rankings/version'

Gem::Specification.new do |spec|
  spec.name          = "men_tennis_rankings"
  spec.version       = MenTennisRankings::VERSION
  ...
  spec.homepage      = "https://github.com/swdavies7/men-tennis-rankings"
  spec.license       = "MIT"
